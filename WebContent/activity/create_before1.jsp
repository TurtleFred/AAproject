...
<body>
<form action="createBefore.action" method="post">
    ...
    <table align="center">
        <caption>
            ...
            <tr>
                <td> 总人数：${people } <input type="hidden" name=people value=${people } /></td>
            </tr>
            <tr>
                <td> 你选择采用标准AA支付，因此每人应支付：${idealCost }<input type="hidden" name=idealCost value=${idealCost } /><script>Cost = ${cost }; people=${people }; per=Cost/people;</script></td>
            </tr>
            <tr><td>请确认活动信息后，依次添加人员：</td></tr>
            
            <tr><td><p><script>addpeople(people)</script></p></td></tr>
